    ...
    <div>
      ...
      <Container maxWidth="xl" sx={{ mt: 5, mb: 5 }}>
        <Paper elevation={3} sx={{ height: '100vh', display: 'flex', flexDirection: 'column' }}>
          <Card sx={{ boxShadow: 0, borderRadius: 2, flex: 1,color: 'black' }}>
            <CardContent sx={{ p: 5 }}>
              {/* Título */}
              <Typography variant="h3" component="h1" gutterBottom sx={{ fontWeight: 'bold ', fontSize: 40  , fontFamily: 'Times New Roman, serif', color: '#2E8B57' }}>
                Industria 4.0: Transformando el Futuro de la Producción
              </Typography>
              
              {/* Línea sutil */}
              <Divider sx={{ borderColor: 'rgba(0, 0, 0, 1)', marginBottom: 4 }} />

              {/* Contenido */}
              <Typography variant="body1" paragraph sx={{fontSize: 20 , fontFamily: 'Times New Roman, serif'}}>
